...
public interface HttpHeaders
{
     ...
     * Submission created
     */
    int CREATED = HttpServletResponse.SC_CREATED;
    
    /**
     * Submission accepted.
     */
    int ACCEPTED = HttpServletResponse.SC_ACCEPTED;
