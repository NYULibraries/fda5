...
import org.dspace.submit.step.DescribeStepNYU;
 ...
 * @version $Revision$
 */
public class JSPDescribeNYUStep extends JSPStep
{
    /** JSP which displays HTML for this Class * */
    private static final String DISPLAY_JSP = "/submit/edit-metadata-nyu.jsp";
    ...
    /** Constructor */
    public JSPDescribeNYUStep() throws ServletException
    {
            ...
            throws SQLException, ServletException, IOException
    {
        ...
        try
        {
            request.setAttribute("submission.inputs", DescribeStepNYU.getInputsReader(formFileName).getInputs(c
                    .getHandle()));
        }
