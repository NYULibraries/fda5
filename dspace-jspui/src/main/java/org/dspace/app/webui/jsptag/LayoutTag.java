...
public class LayoutTag extends BodyTagSupport
{
    ...
    public int doStartTag() throws JspException
    {
        ...
        {
            // We'll always add "DSpace Home" to the a location bar except for home page(modified by Kate)
            String titleFlag=titleKey!=null? titleKey:"";


            if(!titleFlag.equalsIgnoreCase("jsp.home.title")) {
