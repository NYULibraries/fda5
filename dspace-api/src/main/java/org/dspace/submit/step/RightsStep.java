 ...
 * @version $Revision$
 */
public class RightsStep extends AbstractProcessingStep
{
    /** log4j logger */
    private static Logger log = Logger.getLogger(RightsStep.class);
    ...
    /** Constructor */
    public RightsStep() throws ServletException
    {
